...
public abstract class FractalGenerator
{
     ...
     * чтобы содержать начальный диапазон, подходящий для генерируемого фрактала.
     */
     ...
     * она вычисляет и возвращает количество итераций, прежде чем фрактальная функция 
     * покидает ограничивающую область для этой точки. 
     * Точка, которая не проходит до достижения предела итерации, 
     * указывается с результатом -1.
     */
